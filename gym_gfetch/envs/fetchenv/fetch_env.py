...
class GFetch(gym.Env, utils.EzPickle, ABC):
    ...
    def reset_model(self) -> np.ndarray:
        """
        Reset model to initial simulation state & return vector state
        """
    ...
    def step(self, action):
        ...
        for env_indx in range(self.num_envs):
            ...
            infos.append(info)
        return self.state_vector(), torch.tensor(rewards), dones, infos
